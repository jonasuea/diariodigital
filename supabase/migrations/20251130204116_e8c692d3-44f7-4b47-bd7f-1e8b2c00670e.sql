-- Adicionar novos campos na tabela Estudantes
...
ADD COLUMN IF NOT EXISTS estudante_pcd BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS estudante_aee BOOLEAN DEFAULT FALSE,
